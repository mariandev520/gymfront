...
const Clientes = () => {
  ...
  useEffect(() => {
    axios.get('https://gymfront-git-conmogose-mariandev520s-projects.vercel.app/actividades')
  ...
  const handleSubmitNewCliente = (e) => {
    e.preventDefault();
    axios.post('https://gymfront-git-conmogose-mariandev520s-projects.vercel.app/clientes', newCliente)
      .then(response => {
